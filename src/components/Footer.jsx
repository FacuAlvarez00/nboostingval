        ...
        <div className="footer-top">
          <div className="footer-brand">
            ...
            <a
              ...
              className="btn btn-teal footer-wabtn"
            >
          ...
          <div className="footer-links-group">
            <h5>Juegos</h5>
            <ul>
              {['Valorant', 'Counter-Strike 2', 'Marvel Rivals'].map(g => (
                <li key={g}>
                  <a href="#order" onClick={e => { e.preventDefault(); scrollTo('#order') }}>{g}</a>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="footer-links-group">
            <h5>Servicios</h5>
            <ul>
              {['Elo Boost', 'Win Boost', 'Placement Matches', 'Duo Boost'].map(s => (
                <li key={s}>
                  <a href="#order" onClick={e => { e.preventDefault(); scrollTo('#order') }}>{s}</a>
                </li>
              ))}
            </ul>
          </div>
